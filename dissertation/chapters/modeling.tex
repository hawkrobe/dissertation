...
Our model situates semantic meaning within a broader class of computational challenges facing agents in a constantly changing world.
Critically, we appeal to domain-general learning mechanisms rather than specialized language modules: similar inferential mechanisms have been used to understand how internal representations are adapted for motor control \cite{berniker2008estimating}, speech perception \cite{KleinschmidtJaeger15_RobustSpeechPerception}, and visual perception \cite{austerweil2013nonparametric}.
