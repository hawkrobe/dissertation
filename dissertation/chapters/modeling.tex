...
We find that the adapting listener begins at chance because of its uninformative prior, but after interacting with that partner for several rounds, it adapts its lexicon to select the target well above chance. 
...
Thus, its expectations about individual partners' lexica are gradually being incorporated into community-level expectations.
