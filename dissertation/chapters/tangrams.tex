...
To compare word distributions across games, we use a permutation test methodology\footnote{Note that directly measuring divergence between distributions is possible, but because of their sparsity (i.e. many pairs use disjoint sets of words) this approach is not as informative as the continuous semantic analyses we present in the next section}.
...
This discrete measure has both advantages and disadvantages compared to the continuous vector space measures.
