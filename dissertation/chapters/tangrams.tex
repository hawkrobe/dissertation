...
\caption{More distinctive words are more likely to conventionalize. Points represent estimates of the mean probability of conventionalizing across all words with a given distinctiveness value. Size of the point represents the number of points going into mean. Error bars are bootstrapped 95\% CIs.}
\label{fig:distinct}
\end{figure}
...
Similar results are found using \emph{tf-idf}.
