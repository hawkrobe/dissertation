...
%\begin{figure}[ht]
\includegraphics[width=0.5\linewidth]{./figures/graphical/comic.png}
...
\begin{figure*}
\begin{center}
\includegraphics[width=1\linewidth]{task_stimuli.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.84\linewidth]{refgame_BIS_timeseries.pdf}
...
Additionally, the yoked group was more accurate overall at identifying the target object (yoked: 75\%, shuffled: 69\%, $~t = 3.6, ~p < 0.001$). %$0.0004
...
\begin{figure}
\begin{center}
\includegraphics[width=0.92 \linewidth]{recog_BIS_timeseries.pdf}
...
\begin{figure*}
\includegraphics[width=0.94\linewidth]{drawing_changes.pdf}
...
Computational models of sketch production, or lesion analyses like those preliminarily reported above, are promising approaches toward distinguishing among these possibilities in future work.%, in combination with the development of computational models of drawing production that account for part-level semantic structure.
