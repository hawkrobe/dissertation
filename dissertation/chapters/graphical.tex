...
\begin{figure}
\begin{center}
\includegraphics[width=0.5\linewidth]{refgame_BIS_timeseries.pdf}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.5 \linewidth]{recog_BIS_timeseries.pdf}
...
A key experimental design choice was the use of visual objects as the targets of reference, by contrast with the verbal labels or audio clips used in prior work \cite{GalantucciGarrod11_ExperimentalSemiotics,FayGarrodRobertsSwoboda10_InteractiveEvolution}. % both builds on and offers several innovative findings.
